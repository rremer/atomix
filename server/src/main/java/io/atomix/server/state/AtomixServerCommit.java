...
import io.atomix.server.commands.ResourceOperation;
 ...
 */
class AtomixServerCommit implements Commit {
  private final AtomixServerCommitPool pool;
  private Commit<ResourceOperation<?, ?>> commit;
  private ServerSession session;

  public AtomixServerCommit(AtomixServerCommitPool pool) {
    this.pool = pool;
  }
   ...
   */
  void reset(Commit<ResourceOperation<?, ?>> commit, ServerSession session) {
    this.commit = commit;
