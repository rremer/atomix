 ...
 */
public class ResourceDeleteHandler extends RequestHandler {
  ...
  public static class Factory implements RequestHandler.Factory {
    ...
    public RequestHandler createHandler(AtomixServerContext server) {
      return new ResourceDeleteHandler(server);
    }
  }

  public ResourceDeleteHandler(AtomixServerContext server) {
    super(server);
  }
